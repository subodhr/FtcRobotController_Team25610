...
public class DriveFC_ArmControl extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Get arm motors
        DcMotor armPivotMotor = hardwareMap.get(DcMotor.class, "arm_pivot");
        DcMotor armTeleMotor = hardwareMap.get(DcMotor.class, "arm_tele");
        ...
        while (opModeIsActive()) {
            ...
            double armtele = gamepad1.right_trigger;
            double armpivot = gamepad1.left_trigger;
            ...
            armTeleMotor.setPower(armtele*0.2);
            armPivotMotor.setPower(armpivot*0.2);

            telemetry.addData("Status", "Running.cool");
            telemetry.addLine("Apples can peel -- oranges");
            telemetry.addLine(String.format("Ltrig = (%f) --- Rtrig = (%f)", armpivot, armtele));
            telemetry.update();
        }
    }
